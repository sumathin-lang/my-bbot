...
module.exports.setup = function() {
    ...
    bot.connector.onQuery('getSongs', function(event, query, callback) {
        console.info("SSSS get songs ME");
        let randomImageUrl = "https://loremflickr.com/200/200"; // Faker's random images uses lorempixel.com, which has been down a lot
        ...
        attachments.push(
            new builder.ThumbnailCard()
                .title("Hey Jude")
                .text("GetSongs response")
                .images([new builder.CardImage().url(`${randomImageUrl}?random=${0}`)])
                .toAttachment());
